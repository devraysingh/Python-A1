...
# id,name,school,gradyear,course1,grade1,exam1,course2,grade2,exam2,course3,grade3,exam3,degree
...
def get_marks(record, transcript):
    ...
    >>> record = '37,Eyal de Lara,Fort McMurray Composite,2016,MAT,90,92,ENG,92,NE,BIO,77,85,BSci'
    >>> transcript = 'MAT,90,92,ENG,92,NE,BIO,77,85'
    >>> get_marks(record, transcript)
    [91.0, 92.0, 81.0]
    >>> record = '6,Paul Gries,Some Other High School,1990,BIO,61,70,CHM,80,90,CAT,95,96,BEng'
...
def determine_degree_admission(record, name, mark_list): 
    ...
    >>> record = '1,Jacqueline Smith,Grande Prairie Composite,2016,MAT,90,94,ENG,92,88,CHM,80,85,BArts'
    ...
    >>> record = '6,Paul Gries,Some Other High School,1990,BIO,60,70,CHM,80,90,CAT,95,96,BEng'
...
if __name__ == '__main__':
    ...
    records_string = \
'''1,Jacqueline Smith,Best High School,2002,MAT,90,94,ENG,92,88,CHM,80,85,BArts
37,Eyal de Lara,Fort McMurray Composite,2016,MAT,90,92,ENG,92,NE,BIO,77,85,BSci
6,Paul Gries,Another High School,1990,BIO,60,70,CHM,80,90,CAT,95,96,BEng
7,Andrew Petersen,Some Other High School,2016,BIO,83,86,MAT,91,84,SCI,95,77,BMusic
2,Jen Campbell,Yet Another High School,2015,ENG,75,78,SCI,80,81,CHM,80,81,BCom'''    
